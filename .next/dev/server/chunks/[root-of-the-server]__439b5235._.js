...
async function POST(req) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$middleware$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyAuth"])(req);
        // Get token from header
        const authHeader = req.headers.get("authorization");
        const token = authHeader?.substring(7) || "";
        // Logout
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$auth$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AuthService"].logout(token);
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__439b5235._.js.map